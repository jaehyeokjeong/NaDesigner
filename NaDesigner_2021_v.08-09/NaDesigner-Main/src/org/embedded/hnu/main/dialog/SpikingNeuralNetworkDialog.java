...
public class SpikingNeuralNetworkDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setIconImages(null);
        setMinimumSize(new java.awt.Dimension(625, 700));
        ...
        runtimeComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "NengoDL", "NAAL", "ONNX", "DE1-SoC", "N3ML" }));
    ...
    logPanelLayout.setVerticalGroup(
        ...
        .addGroup(logPanelLayout.createSequentialGroup()
            .addContainerGap()
            .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 11, Short.MAX_VALUE)
            .addContainerGap())
    );
    ...
    libraryDirPanelLayout.setHorizontalGroup(
        ...
        .addGroup(libraryDirPanelLayout.createSequentialGroup()
            ...
            .addGap(8, 8, 8)
            .addComponent(libraryDirTextField)
            .addGap(10, 10, 10)
    ...
    n3mlLoadDataPanel1Layout.setHorizontalGroup(
        ...
        .addGroup(n3mlLoadDataPanel1Layout.createSequentialGroup()
            ...
            .addGap(10, 10, 10)
            .addComponent(n3mlLoadDirTextField)
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    n3mlNeuronModelComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CUBA LIF Model", "COBA LIF Model", "IF Model", "SRM Model" }));
    ...
    n3mlLearningAlgorithmComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ReSuMe", "softLIF", "SpikeProp", "STDP", "BP-STDP" }));
    ...
    layout.setHorizontalGroup(
        ...
        .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(logPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 586, Short.MAX_VALUE)
    ...
    layout.setVerticalGroup(
        ...
        .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(logPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
            .addGap(10, 10, 10)
...
//            libraryDirTextField.setText("This is your N3ML library directory.");
    ...
    private void showInputNumberLayerDialog(HSNNIOConfig hSIOConf, boolean selectedCNN){
        InputNumberLayerDialog dialog = new InputNumberLayerDialog(null, true, hSNNGen, hSIOConf, selectedCNN);        
    ...
    private void showN3MLAlgorithmAdialog(int neuronModel, int algorithm){
        N3MLAlgorithmDialog dialog = new N3MLAlgorithmDialog(null, true, hN3mlGen, hN3mlIOConf, neuronModel, algorithm, hDataSetOpt);
        dialog.setLocationRelativeTo(null);
        //cancel();
        dialog.setVisible(true);
    }
    ...
    private void initNengoDL(String modelName, String modelDir){
        ...
        hSIOConf.setLearning_rate(Double.parseDouble(learningRateTextField.getText()));
...
//        hN3mlIOConf = new HN3MLoldIOConfig(1, 1, 2, 2);
        ...
        switch(neuronmodel){
            case H_N3ML_NM_CUBA_LIF_MODEL:
                hN3mlNeuronModel = H_N3ML_NM_CUBA_LIF_MODEL; break;
            case H_N3ML_NM_COBA_LIF_MODEL:
                hN3mlNeuronModel = H_N3ML_NM_COBA_LIF_MODEL; break;
    ...
    private void loadLib(int state) {
        ...
        if(state == H_DE1_SOC ){
            ...
            destLib = new File(srcDir.getAbsolutePath() + File.separatorChar + "src" +File.separatorChar + "hnu" + File.separatorChar + "n3ml");
        }
        destLib.mkdirs();
    }
