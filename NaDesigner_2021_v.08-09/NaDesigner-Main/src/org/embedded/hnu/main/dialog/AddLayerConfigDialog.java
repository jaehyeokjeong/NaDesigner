...
public class AddLayerConfigDialog extends javax.swing.JDialog {
    ...
    public AddLayerConfigDialog(java.awt.Frame parent, boolean modal, int numLayer, HSNNGenerator hSGen, HSNNIOConfig hSIOConf) {
        super(parent, modal);
    ...
    private void layerComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_layerComboBoxActionPerformed
        ...
        else if(selected.toString().equals("Layer 3")){
    ...
    public void setLayerConfig(int layerN){
        ...
        hSLCfg = new HSNNLayerConfig(filter, kernel, stride, padding);
