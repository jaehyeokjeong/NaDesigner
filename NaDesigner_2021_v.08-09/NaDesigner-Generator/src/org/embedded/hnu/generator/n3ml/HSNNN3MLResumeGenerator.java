 ...
 * @author SeoyeonKim
 */
public class HSNNN3MLResumeGenerator {
    
    public static final int H_N3ML_NM_CUBA_LIF_MODEL = 0;
    ...
    public HSNNN3MLResumeGenerator(HN3MLIOConfig n3mlCfg, int neuronmodel) {
        super();
